...
#ifndef METAL_RESOURCE_FACTORY_H
#define METAL_RESOURCE_FACTORY_H

#import "MetalCommon.h"
#import "MetalContext.h"
#import "MetalTexture.h"

@interface MetalResourceFactory : NSObject
{
    MetalContext* context;
    id<MTLLibrary> shaderLibrary;
}

- (MetalRTTexture*) createRTT;
- (void) disposeRTT:(MetalRTTexture*) rtt;

- (MetalTexture*) createTexture;
- (void) disposeTexture:(MetalTexture*) texture;

- (id<MTLBuffer>) allocateBuffer;
- (void) releaseBuffer;
